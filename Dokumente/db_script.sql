...
insert into eli_location values(eli_seq_location.nextval, '40a', 'Bahnhofstraße', 9560, 'Feldkichen in Kärnten', 4);
insert into eli_location values(eli_seq_location.nextval, null, 'St. Stefan', 9560, 'Feldkichen in Kärnten', 8);
